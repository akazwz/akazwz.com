	...
	return (
		<div className="min-h-dvh bg-gray-900 flex items-center justify-center p-4">
			<div className="max-w-lg mx-auto text-center space-y-8">
				{/* Avatar Section */}
				<div className="w-24 h-24 mx-auto rounded-full overflow-hidden border-2 border-gray-700">
					<img
						src="/akazwz.webp"
						alt="akazwz avatar"
				...
				<div className="space-y-3">
					<h1 className="text-4xl font-bold text-white">AKAZWZ</h1>
					<p className="text-lg text-gray-400">Developer & Creator</p>
				</div>
				...
				<div className="pt-4">
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="inline-flex items-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-medium transition-colors"
					>
